...
export default createSelector(
    ...
    (activeDate, isAddEditFormShown, toDoItemDate, toDoItemText, toDoItemTitle, allToDoItems) => {
        ...
        return {
            ...
            toDoItemTitle,
            toDoItemText,
            dateInputLabel: CalendarViewTexts.DATE_INPUT_LABEL,
            dateInputPrompt: CalendarViewTexts.DATE_INPUT_PROMPT,
            titleInputLabel: CalendarViewTexts.TITLE_INPUT_LABEL,
            titleInputPrompt: CalendarViewTexts.TITLE_INPUT_PROMPT,
            textInputLabel: CalendarViewTexts.TEXT_INPUT_LABEL,
            textInputPrompt: CalendarViewTexts.TEXT_INPUT_PROMPT,
            toDoItemDate,
            isAddEditFormShown,
